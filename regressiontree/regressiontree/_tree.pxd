...
cdef class TreeBuilder:
    ...
    cdef double min_impurity_decrease   # Impurity decrease threshold for early stopping
    cdef double min_mrss                # Minimum resdidual sum of squares threshold for early stopping
