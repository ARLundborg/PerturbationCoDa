...
cdef class Criterion:
    ...
    # Internal structures
    cdef SIZE_t curr_feature             # Current feature
    cdef const DTYPE_t[:, :] X		 # Values of X
    # cdef const DOUBLE_t[:, :] X		 # Values of X
...
cdef class RegressionCriterion(Criterion):
    ...
    cdef double[::1] res_sq_sum_total   # The sum of w*(y-yhat)**2.
    cdef double[::1] res_sq_sum_left    # Same as above, but for the left side of the split
    cdef double[::1] res_sq_sum_right   # Same as above, but for the right side of the split
