...
- `sim_adult_experiments` contains the code for the experiment and plot in Section 5.1.1 of the paper based on the "Adult" dataset. This requires downloading the dataset as described in the data README file in `data/adult`.
...
- `sim_ny_schools.py` contains the code for the experiment in Section 5.1.2 of the paper based on the PASSNYC data set. This requires downloading the dataset as described in the data README file in `data/ny-schools`.
